...
/*   Updated: 2024/03/09 23:10:12 by emduncan         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/*The ft_strlcat function takes a destination buffer dest, a source string src, and the size of the destination buffer destsize.
It calculates the length of dest and src and checks if the destination buffer is large enough to accommodate the concatenation.
If the destination buffer is too small, it returns the length that would have been copied if the buffer were large enough.
Otherwise, it copies characters from src to dest, ensuring null termination, and returns the total length of the concatenated string.*/